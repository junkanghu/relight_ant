...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return_dict = {
            ...
            'prt_d': torch.randn([3, 3, 512, 512]),
            'prt_s': torch.randn([3, 3, 512, 512]),
            'shading': torch.randn([3, 3, 512, 512]),
            'albedo': torch.randn([3, 3, 512, 512]),
            'mask': torch.randn([3, 1, 512, 512]),
            'transport_d': torch.randn([3, 25, 512, 512]),
            'transport_s': torch.randn([3, 25, 512, 512]),
            'light': torch.randn([3, 25, 3]),
            'name': 'hu'
        }
        ...
        if self.opt.use_res:
            ...
            return_dict.update({
                'bprt_d': torch.randn([3, 3, 512, 512]),
                'bshading': torch.randn([3, 3, 512, 512])
            })
        return return_dict
...
def create_dataset(opt):
    ...
    train_dir, valid_dir, light_info = [], [], []
